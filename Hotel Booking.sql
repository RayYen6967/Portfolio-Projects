...
temp2 as (select meal, market_segment, distribution_channel, deposit_type, customer_type, is_canceled,
          ...
          from temp1)
select iif(meal = 'Undifined', 'SC', meal) as meal, iif(market_segment = 'Undifined', 'Excluded', market_segment) as market_segment,
       iif(distribution_channel = 'Undifined', 'Excluded', distribution_channel) as distribution_channel, deposit_type, customer_type,
